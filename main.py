...
def run_alex():
    ...
    try:
        ...
        if 'hello' in command :
            ...
            print('I am Alex a k a your virtual assistant master')
            engine_talk('I am Alex a k a your virtual assistant master. how can i help you ??')
...
engine_talk ("Hello, I am Alex, how may i help you ?")
while True:
    run_alex()